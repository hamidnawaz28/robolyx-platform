...
from .views import BusinessUnitViewSet, DepartmentViewSet, TagsViewSet, RegionsViewSet, DivisionsViewSet, SitesViewSet, PaymentTermViewSet, PaymentTermList
...
router.register("payment-term-list", PaymentTermList, basename='payment-term-list')
