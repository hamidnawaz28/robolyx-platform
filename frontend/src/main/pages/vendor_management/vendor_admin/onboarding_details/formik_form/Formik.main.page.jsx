...
export default function MainFormik({ vendor }) {
	...
	const reduxVals = {
		category: vendor.category ? vendor.category.map((cat) => cat.name) : [],
		diversity: vendor.diversity ? vendor.diversity.map((cat) => cat.name) : [],
		payment_term: vendor.payment_term
			? vendor.payment_term.map((cat) => cat.name)
			: [],
		tags: vendor.tags ? vendor.tags.map((cat) => cat.name) : [],
		trades: vendor.trades ? vendor.trades.map((cat) => cat.name) : [],
	};
