...
export default function DeleteDialog({ addressId, venId }) {
  ...
  const handleDelete = () => {
    var config = {
      method: "delete",
      url: `http://127.0.0.1:8090/api/vendor_management/vendor-address/${addressId}`,
      headers: {
    ...
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">
          {`Are you sure you want to delete address id ${addressId} ?`}
        </DialogTitle>
