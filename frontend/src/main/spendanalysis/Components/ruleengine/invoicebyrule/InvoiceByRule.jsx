...
function InvoiceByRule() {
  ...
  const implementedRulesPk = useSelector(
    (state) => state.utilsData.implementedRulesPk
  );
          ...
          <Grid container spacing={0}>
            <Grid style={{ width: "100px" }}>
              <DropDownSelect
                ...
                onChangeEvent={(e) =>
                  setFormData({ ...initialState, pk: e.target.value })
                }
              />
            </Grid>
            <Grid>
                  ...
                  <Box m={1}>
                    <DropDownSelect
                      ...
                      onChangeEvent={(e) =>
                        setFormData({
                          ...formData,
                          [`CATEGORY_LEVEL_${item}`]: e.target.value,
                          pk: "",
                        })
                      }
                    />
