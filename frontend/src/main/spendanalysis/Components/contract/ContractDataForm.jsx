          ...
          <DialogContent>
            <Formik
              ...
              validationSchema={Yup.object({
                ...
                SUPPLY_TYPE: Yup.string().required("  *Required"),
                STATUS: Yup.string().required("  *Required"),
                CONTRACT_STATUS: Yup.string().required("  *Required"),
                CONTRACT_MANAGER: Yup.string().required("  *Required"),
                CONTRACT_ITEMS: Yup.string().required("  *Required"),
              })}
              onSubmit={(values) => {
                debugger;
                alert(JSON.stringify(values, null, 2));
