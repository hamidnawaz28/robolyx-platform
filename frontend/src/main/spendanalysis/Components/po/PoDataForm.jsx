                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INVOICE_ID' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INV_ORIGIN' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INV_SOURCE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INV_NUMBER' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INV_TERMS' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6}  >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'GL_DATE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'INV_DATE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'VENDOR_NUMBER' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4}>
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'VENDOR_NAME' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={4} sm={4} md={4} lg={4} xl={4} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'VENDOR_TYPE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_NUMBER' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_TYPE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_DESCRIPTION' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_QUANTITY' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_UNIT_PRICE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_UNIT_OF_MEASURE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LINE_AMOUNT' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'GENERAL_LEDGER' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'LOCATION' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'DEPARTMENT' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            ...
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'ACCOUNT' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'PO_NUMBER' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                            <Grid xs={6} sm={6} md={6} lg={6} xl={6} >
                                <Box m={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setPopupFormData({...popupFormData, 'CREATION_DATE' : e.target.value})}
                                    />
                                </Box>
                            </Grid>
                        </Grid>
